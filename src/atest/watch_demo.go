...
func main() {
	...
	for i:=0;i<5;i++ {
		...
		value.WriteString("hello topic_desc ")
		value.WriteString(strconv.Itoa(i))
		factory.UpdateValue("topic_desc",value.String())
	}
	...
	go func() {
		//factory.RemoveObserver("topic_desc",w1);
		factory.RemoveTopic("topic_desc");
	}()
